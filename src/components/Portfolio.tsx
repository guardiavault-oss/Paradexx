      ...
      <div className="max-w-7xl mx-auto">
        ...
        >
          <div className="flex items-center justify-between mb-4">
            ...
            >
              <RefreshCw className="w-5 h-5 text-[var(--text-primary)]/70" />
            </motion.button>
          </div>
          ...
          >
            ...
            <div className="relative">
              <p className="text-sm text-[var(--text-primary)]/50 mb-2 uppercase tracking-wider">Total Value</p>
              <div className="flex items-end justify-between flex-wrap gap-4">
                ...
                <div className="flex gap-6">
                  <div>
                    <p className="text-xs text-[var(--text-primary)]/40 mb-1">Assets</p>
                    <p className="text-xl font-bold text-[var(--text-primary)]">{holdings.length}</p>
                  </div>
                  <div>
                    <p className="text-xs text-[var(--text-primary)]/40 mb-1">Favorites</p>
        ...
        <div className="grid grid-cols-1 xl:grid-cols-3 gap-6">
                    ...
                    <div className="flex items-center gap-4 relative">
                      ...
                      <div className="flex-1 min-w-0">
                        <div className="flex items-center gap-2 mb-1">
                          ...
                          <span className="text-sm text-[var(--text-primary)]/40">{token.name}</span>
                        </div>
                      ...
                      <ArrowUpRight
                        className="w-5 h-5 text-[var(--text-primary)]/20 group-hover:text-[var(--text-primary)]/60 transition-colors"
                        style={{
          ...
          >
            <div className="flex items-center justify-between mb-6">
              <h3 className="text-xl font-black text-[var(--text-primary)]">Allocation</h3>
              <div
              ...
              <div className="relative w-full h-full flex items-center justify-center">
                ...
                >
                  <div className="text-center">
                    <p className="text-xs text-[var(--text-primary)]/40 mb-1">Total</p>
                    <p className="text-sm font-black text-[var(--text-primary)]">100%</p>
                  </div>
                </div>
              </div>
            </div>
              ...
              {holdings.slice(0, 6).map((token, index) => (
                ...
                >
                  <div className="flex items-center gap-3 flex-1">
                    ...
                    />
                    <span className="text-sm font-semibold text-[var(--text-primary)] group-hover:text-[var(--text-primary)]/80 transition-colors">
                      {token.symbol}
                    </span>
                  </div>
                  <div className="text-right">
                    <span className="text-sm font-bold text-[var(--text-primary)]/70">
            ...
            >
              <span className="text-sm font-bold text-[var(--text-primary)]/60">Portfolio</span>
