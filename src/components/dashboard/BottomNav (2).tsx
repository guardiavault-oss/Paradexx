...
export default function BottomNav({
  ...
  return (
    ...
    >
      <div className="max-w-[600px] mx-auto px-2 py-2 rounded-[10px] bg-[rgba(255,250,250,0)]">
        <div className="flex items-center justify-around bg-[rgba(0,0,0,0)]">
          {tabs.map((tab) => {
            const Icon = tab.icon;
            ...
            return (
              <button
                ...
                className="relative flex flex-col items-center justify-center gap-1 min-w-[64px] py-2 transition-all font-[Bebas_Neue] bg-[rgba(0,0,0,0)] text-[36px] text-[rgb(255,255,255)] font-bold italic no-underline"
              >
