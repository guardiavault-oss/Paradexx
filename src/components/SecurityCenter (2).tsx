            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                <div className="flex items-center gap-2">
                  ...
                  <h2 className="text-white">Security Center</h2>
                </div>
                <p className="text-xs text-white/50 mt-0.5">Protect your assets</p>
              </div>
            </div>
              ...
              >
                <div className="flex items-center justify-between mb-4">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <div className="text-4xl text-white mb-1">{securityScore}</div>
                    ...
                    >
                      <div className="flex items-center gap-3">
                        ...
                        <div className="flex-1 min-w-0">
                          <div className="text-white text-sm mb-1">{check.title}</div>
                          <div className="text-xs text-white/50 truncate">{check.description}</div>
                        </div>
            ...
            >
              ...
              {approvals.length === 0 ? (
                <div className="p-8 text-center">
                  ...
                  <div className="text-white mb-1">No Active Approvals</div>
                  <p className="text-sm text-white/50">Your wallet has no token approvals</p>
                </div>
              ) : (
                    ...
                    >
                      <div className="flex items-start justify-between mb-3">
                        <div className="flex items-center gap-3">
                          ...
                          <div>
                            <div className="text-white">{approval.tokenSymbol}</div>
                      ...
                      <div className="flex items-center justify-between">
                        <div>
                          <div className="text-xs text-white/50">Approved Amount</div>
                          <div
                            className={approval.isUnlimited ? "text-orange-400" : "text-white"}
                          >
            ...
            >
              ...
              {connectedDapps.length === 0 ? (
                <div className="p-8 text-center">
                  ...
                  <div className="text-white mb-1">No Connected dApps</div>
                  <p className="text-sm text-white/50">Connect to dApps to see them here</p>
                </div>
              ) : (
                <div className="space-y-3">
                    ...
                    >
                      <div className="flex items-start justify-between mb-3">
                        <div className="flex items-center gap-3">
                          ...
                          <div>
                            <div className="text-white">{dapp.name}</div>
                            <div className="text-xs text-white/50">{dapp.url}</div>
                          </div>
                        </div>
                      ...
                      <div className="flex items-center justify-between">
                        <div className="text-xs text-white/40">Connected {dapp.connectedAt}</div>
              ...
              {[
                ...
                >
                  <div className="flex items-center gap-3">
                    ...
                    <div className="flex-1 min-w-0">
                      <div className="text-white text-sm">{setting.title}</div>
                      <div className="text-xs text-white/50">{setting.desc}</div>
                    </div>
                    <div className="flex items-center gap-2">
