      ...
      >
        <div className="px-4 sm:px-6 py-4 flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            >
              <Flame className="w-6 h-6 text-[var(--text-primary)]" />
            </div>
            <div>
              <h1 className="text-xl sm:text-2xl font-black text-[var(--text-primary)] uppercase">Meme Radar</h1>
          ...
          <div className="flex items-center gap-2">
            <button
              ...
              className={`p-2 sm:p-3 rounded-xl transition-all ${autoRefresh ? "bg-[#00FF88]/20" : "hover:bg-white/10"
                }`}
          ...
          >
            <div className="relative">
              ...
              <input
                ...
                className="w-full pl-10 pr-4 py-3 rounded-xl text-[var(--text-primary)] placeholder-white/40 focus:outline-none transition-all"
                style={{
            ...
            <div className="flex flex-wrap gap-3">
              <select
                ...
                className="px-4 py-2 rounded-xl text-[var(--text-primary)] focus:outline-none transition-all"
                style={{
                  backgroundColor: "rgba(0, 0, 0, 0.6)",
                  border: "1px solid rgba(220, 20, 60, 0.3)",
                }}
                      ...
                      <div className="p-5 relative z-10">
                        <div className="flex items-start justify-between mb-4">
                          <div className="flex items-center gap-3">
                            ...
                            <div>
                              <h3 className="text-[var(--text-primary)] font-black text-lg">{token.tokenName}</h3>
                              <div className="flex items-center gap-2">
                                <span className="text-[var(--text-primary)]/60 text-sm">${token.tokenSymbol}</span>
                        ...
                        <div className="grid grid-cols-2 gap-4 mb-4">
                          <div>
                            <p className="text-[var(--text-primary)]/60 text-xs mb-1">Price</p>
                            <p className="text-[var(--text-primary)] font-bold">${token.priceAction.currentPrice}</p>
                            <div
                          ...
                          <div>
                            <p className="text-[var(--text-primary)]/60 text-xs mb-1">Virality Score</p>
                            <div className="flex items-center gap-2">
                        ...
                        <div className="flex items-center justify-between">
                          <div className="flex items-center gap-2">
                            ...
                            <span className="text-[var(--text-primary)]/60 text-xs">
      ...
      <AnimatePresence>
        {selectedToken && (
          <motion.div
            ...
            animate={{ opacity: 1 }}
            exit={{ opacity: 0 }}
            className="fixed inset-0 bg-[var(--bg-base)]/80 z-[60] flex items-center justify-center p-4"
            ...
            >
              <div className="flex items-center justify-between mb-6">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <h2 className="text-2xl font-black text-[var(--text-primary)]">{selectedToken.tokenName}</h2>
                    <p className="text-[var(--text-primary)]/60">${selectedToken.tokenSymbol}</p>
                  </div>
                </div>
                <button
                  onClick={() => setSelectedToken(null)}
              ...
              <div className="space-y-6">
                ...
                <div className="grid grid-cols-2 gap-4">
                  ...
                  >
                    <p className="text-[var(--text-primary)]/60 text-xs mb-1">Risk Score</p>
                    <div
                ...
                >
                  <p className="text-xs text-[var(--text-primary)]/60 text-center">
