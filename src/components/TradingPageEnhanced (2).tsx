...
export function TradingPageEnhanced({ type, onClose }: TradingPageProps) {
  ...
  return (
    <div className="min-h-screen overflow-y-auto pb-24">
      {/* Header */}
      <div className="sticky top-16 z-20 backdrop-blur-xl border-b border-white/10 bg-black/80 px-[-135px] mx-[225px] my-[35px] mt-[8px] mr-[191px] mb-[29px] ml-[210px] bg-[rgba(0,0,0,0.6)] rounded-[39px] px-[-20px] py-[-67px]">
        <div className="md:px-6 bg-[rgba(0,0,0,0)] px-[-5px] mx-[14px] my-[41px] rounded-[51px] p-[17px]">
          <div className="flex items-center justify-between mb-4 bg-[rgba(0,0,0,0)]">
