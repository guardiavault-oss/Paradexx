      ...
      <Section padding="none">
        <VStack spacing="sm">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            >
              <VStack spacing="md">
                <div className="flex items-center justify-between w-full bg-[rgba(0,0,0,0)]">
                ...
                <div className="w-full space-y-3 px-[20px] py-[0px]">
                  <div className="flex items-center justify-between bg-[rgba(0,0,0,0.4)]">
            ...
            >
              <VStack spacing="md">
                ...
                <div className="w-full space-y-3 bg-[rgba(0,0,0,0)]">
                  {watchlist.map((token) => (
                    <div
                      key={token.symbol}
                      className="flex items-center justify-between bg-[rgba(0,0,0,0)]"
                    >
