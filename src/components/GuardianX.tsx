            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                <div className="flex items-center gap-2">
                  ...
                  <h2 className="text-[var(--text-primary)]">GuardianX</h2>
                </div>
        ...
        <AnimatePresence mode="wait">
          ...
          {activeTab === "overview" && (
            ...
            >
                ...
                <div className="relative z-10">
                  <div className="flex items-center justify-between mb-4">
                    <div className="flex items-center gap-2">
                      ...
                      <span className="text-sm text-[var(--text-primary)]/70">Legacy Vault Balance</span>
                    </div>
                    <div
                  ...
                  <div className="flex items-baseline gap-2 mb-6">
                    <span className="text-4xl text-[var(--text-primary)]">{vaultStats.vaultBalance}</span>
                    <span className="text-xl text-[var(--text-primary)]/50">ETH</span>
                  </div>

                  <div className="grid grid-cols-2 gap-4">
                    <div>
                      <div className="text-xs text-[var(--text-primary)]/50 mb-1">Beneficiaries</div>
                      <div className="text-lg text-[var(--text-primary)]">{beneficiaries.length}</div>
                    </div>
                    <div>
                      <div className="text-xs text-[var(--text-primary)]/50 mb-1">Timelock</div>
                      <div className="text-lg text-[var(--text-primary)]">{vaultStats.timelockDays} days</div>
                    </div>
                  </div>
                </div>
              </div>
              ...
              >
                <div className="flex items-center justify-between mb-4">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <div className="text-[var(--text-primary)] mb-1">Life Check-In</div>
                  ...
                  <motion.button
                    ...
                    className="px-4 py-2 rounded-xl text-[var(--text-primary)] font-bold"
                    style={{
                      background: colors.gradient,
                ...
                >
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-sm text-[var(--text-primary)]">Check-in Streak</span>
                  </div>
                  <span className="text-[var(--text-primary)] font-bold">{vaultStats.checkInStreak} days</span>
                </div>
              </div>
              ...
              >
                <div className="flex items-center justify-between mb-4">
                  <div className="text-[var(--text-primary)]">Vault Health Score</div>
                  <div
                  ...
                  {[
                    ...
                    <div key={index} className="flex items-center gap-2 text-sm">
                      {item.done ? (
                        ...
                        <AlertCircle className="w-4 h-4 text-[var(--text-primary)]/30" />
                      )}
                      <span className={item.done ? "text-[var(--text-primary)]" : "text-[var(--text-primary)]/50"}>
                        {item.label}
                      </span>
                    </div>
                  ))}
              ...
              <div className="grid grid-cols-3 gap-3">
                ...
                >
                  ...
                  <div className="text-2xl text-[var(--text-primary)] mb-1">{beneficiaries.length}</div>
                  <div className="text-xs text-[var(--text-primary)]/50">Heirs</div>
                </div>
                <div
                  className="p-4 rounded-xl text-center"
                  style={{
                ...
                >
                  ...
                  <div className="text-2xl text-[var(--text-primary)] mb-1">{messages.length}</div>
                  <div className="text-xs text-[var(--text-primary)]/50">Messages</div>
                </div>
                <div
                  className="p-4 rounded-xl text-center"
                  style={{
                ...
                >
                  ...
                  <div className="text-2xl text-[var(--text-primary)] mb-1">{vaultStats.timelockDays}</div>
                  <div className="text-xs text-[var(--text-primary)]/50">Days</div>
                </div>
              </div>
              ...
              >
                <div className="flex items-start justify-between">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <div className="text-[var(--text-primary)] mb-1 font-bold">AI Will Builder</div>
          ...
          {activeTab === "beneficiaries" && (
            ...
            >
              ...
              >
                <div className="text-[var(--text-primary)] mb-4">Allocation Distribution</div>
                <div className="space-y-3">
                  {beneficiaries.map((ben, index) => (
                    <div key={ben.id}>
                      <div className="flex items-center justify-between mb-2">
                        <span className="text-sm text-[var(--text-primary)]/70">{ben.name}</span>
                        <span className="text-sm text-[var(--text-primary)] font-bold">{ben.allocation}%</span>
                      </div>
                  ...
                  >
                    <div className="flex items-center justify-between mb-3">
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          <div className="text-[var(--text-primary)]">{ben.name}</div>
                          <div className="text-sm text-[var(--text-primary)]/50">{ben.relationship}</div>
                        </div>
                      </div>
                      <ChevronRight className="w-5 h-5 text-[var(--text-primary)]/30" />
                    </div>

                    <div
                      className="pt-3 border-[var(--border-neutral)] flex items-center justify-between"
                      style={{ borderColor: colors.border }}
                    >
                      <div className="text-xs text-[var(--text-primary)]/50">{ben.address}</div>
                      <div
                        className="px-2 py-1 rounded text-xs"
                        style={{
                          background: "rgba(34, 197, 94, 0.2)",
                  ...
                  >
                    <div className="flex items-start justify-between mb-3">
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          <div className="text-[var(--text-primary)] mb-1">To: {msg.recipient}</div>
                    ...
                    {msg.preview && (
                      <div
                        className="p-3 rounded-xl text-sm text-[var(--text-primary)]/70"
          ...
          {activeTab === "guardians" && (
            ...
            >
              ...
              >
                <Shield className="w-16 h-16 mx-auto mb-4 text-[var(--text-primary)]/20" />
                <div className="text-[var(--text-primary)] mb-2">Social Recovery Guardians</div>
                <p className="text-sm text-[var(--text-primary)]/50 mb-6">
                  Invite trusted contacts to help recover your vault
                </p>
                <motion.button
                  whileTap={{ scale: 0.95 }}
                  className="px-6 py-3 rounded-xl text-[var(--text-primary)] font-bold"
                  style={{
                    background: colors.gradient,
                    border: `1px solid ${colors.primary}`,
                  }}
        ...
        {showCheckInModal && (
          <>
            ...
            >
              ...
              >
                <Heart className="w-8 h-8 text-[var(--text-primary)]" />
              </motion.div>
              <h3 className="text-xl text-[var(--text-primary)] mb-2">Check-In Successful!</h3>
