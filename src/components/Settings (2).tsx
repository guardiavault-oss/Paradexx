...
export function Settings({ type, onClose, activeTab, onTabChange, onTribeSwitch }: SettingsProps) {
  ...
  return (
    <motion.div
      ...
      animate={{ opacity: 1 }}
      exit={{ opacity: 0 }}
      className="bg-black text-white pb-24 md:pb-20 pt-20"
    >
      ...
      <div className="flex items-center justify-between px-4 mb-6 max-w-7xl mx-auto">
        <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-white/50">Customize your wallet</p>
            </div>
        </div>
        <motion.button
            whileHover={{ scale: 1.05 }}
          ...
          <div className="flex gap-2 overflow-x-auto pb-2 scrollbar-hide">
            {tabs.map((tab) => (
              <motion.button
                ...
                style={{
                  background: currentTab === tab.id ? accentColor : 'rgba(255, 255, 255, 0.05)',
                  border: `1px solid ${currentTab === tab.id ? accentColor : 'rgba(255, 255, 255, 0.1)'}`,
                  color: currentTab === tab.id ? 'white' : 'rgba(255, 255, 255, 0.6)',
                }}
              >
          ...
          >
              ...
              <>
                ...
                >
                  <div className="flex items-center justify-between mb-4">
                    <div>
                      <div className="text-sm text-white/60 mb-1">Current Tribe</div>
                ...
                <div className="p-6 rounded-xl bg-white/5 border border-white/10 space-y-4">
                  ...
                  <div>
                    ...
                    <input
                      ...
                      className="w-full px-4 py-3 rounded-lg bg-black border border-white/10 text-white focus:outline-none focus:border-white/30"
                    />
                  </div>
                  ...
                  <div>
                    ...
                    <div className="flex items-center gap-2">
                      <input
                        ...
                        disabled
                        className="flex-1 px-4 py-3 rounded-lg bg-black border border-white/10 text-white/50 font-mono text-sm"
                      />
                      <motion.button
                        whileHover={{ scale: 1.05 }}
                        whileTap={{ scale: 0.95 }}
                    ...
                    <p className="text-xs text-white/40 mt-2">Connected wallet cannot be changed</p>
                  </div>
                </div>
                    ...
                    <div className="flex-1">
                      <div className="flex gap-2">
                        <motion.button
                          whileHover={{ scale: 1.02 }}
                          whileTap={{ scale: 0.98 }}
                          className="px-4 py-2 rounded-lg font-bold text-sm bg-white/5 border border-white/10"
                        >
                ...
                <div className="p-6 rounded-xl bg-white/5 border border-white/10">
                  <div className="flex items-center justify-between mb-4">
                    <div>
                      ...
                      <p className="text-xs text-white/60">Extra layer of security for your account</p>
                    </div>
                    <motion.button
                      whileHover={{ scale: 1.05 }}
                      whileTap={{ scale: 0.95 }}
                ...
                <div className="p-6 rounded-xl bg-white/5 border border-white/10">
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <p className="text-xs text-white/60">Use fingerprint or Face ID</p>
                    </div>
                    <motion.button
                      whileHover={{ scale: 1.05 }}
                      whileTap={{ scale: 0.95 }}
              ...
              <>
                ...
                <div className="p-6 rounded-xl bg-white/5 border border-white/10 space-y-4">
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <div className="text-xs text-white/60">Blur amounts in your wallet</div>
                    </div>
                    <motion.button
                      whileHover={{ scale: 1.05 }}
                      whileTap={{ scale: 0.95 }}
                  ...
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <div className="text-xs text-white/60">Help improve Paradex Wallet</div>
                    </div>
                    <motion.button
                      whileHover={{ scale: 1.05 }}
                      whileTap={{ scale: 0.95 }}
                ...
                <div className="p-6 rounded-xl bg-white/5 border border-white/10 space-y-3">
                  ...
                  <motion.button
                    whileHover={{ scale: 1.02 }}
                    whileTap={{ scale: 0.98 }}
                    className="w-full p-3 rounded-lg bg-white/5 border border-white/10 flex items-center justify-between"
                  >
            ...
            {currentTab === 'preferences' && (
              <>
                {/* Network */}
                <div className="p-6 rounded-xl bg-white/5 border border-white/10">
                  <label className="text-xs text-white/60 uppercase tracking-wide mb-3 block">
                    Default Network
                  </label>
                  <select
              ...
              <>
                ...
                <div className="p-6 rounded-xl bg-white/5 border border-white/10">
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <p className="text-xs text-white/60">Access advanced features & APIs</p>
                    </div>
                    <motion.button
                      whileHover={{ scale: 1.05 }}
                      whileTap={{ scale: 0.95 }}
                ...
                <div className="p-6 rounded-xl bg-white/5 border border-white/10">
                  ...
                  <input
                    ...
                    className="w-full px-4 py-3 rounded-lg bg-black border border-white/10 text-white font-mono text-sm focus:outline-none focus:border-white/30"
                  />
                  <p className="text-xs text-white/40 mt-2">Use custom RPC endpoint for transactions</p>
                </div>
                ...
                <div className="p-6 rounded-xl bg-white/5 border border-white/10">
                  ...
                  <div className="flex items-center gap-2">
                    <input
                      ...
                      readOnly
                      className="flex-1 px-4 py-3 rounded-lg bg-black border border-white/10 text-white/70 font-mono text-sm"
                    />
                    <motion.button
                      whileHover={{ scale: 1.05 }}
                      whileTap={{ scale: 0.95 }}
                ...
                <motion.button
                  whileHover={{ scale: 1.02 }}
                  whileTap={{ scale: 0.98 }}
                  className="w-full p-4 rounded-xl bg-white/5 border border-white/10 flex items-center justify-center gap-2 text-white/80"
                >
                  <RefreshCw className="w-5 h-5" />
                  Reset to Defaults
                </motion.button>
