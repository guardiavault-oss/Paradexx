...
function SessionCard({
  ...
  return (
    ...
    >
      ...
      <div className="p-4 bg-white/5 border border-white/10 rounded-xl hover:border-white/20 transition-all relative overflow-hidden">
        {/* Shimmer effect */}
        <motion.div
        ...
        <div className="flex items-start gap-4 relative z-10">
          ...
          <div className="flex-1 min-w-0">
            <h3 className="text-sm font-bold text-white mb-1">{session.peerMeta.name}</h3>
            <p className="text-xs text-white/60 mb-2 truncate">{session.peerMeta.url}</p>
    ...
    <AnimatePresence>
      ...
      >
        <motion.div
          ...
          className="w-full max-w-lg bg-black rounded-2xl border border-white/10 overflow-hidden relative"
        >
            ...
            {view === 'list' ? (
                ...
                {sessions.length > 0 && (
                  ...
                  >
                    ...
                    <input
                      ...
                      className="w-full pl-10 pr-4 py-2 bg-white/5 border border-white/10 rounded-xl text-sm text-white placeholder-white/40 focus:border-white/30 outline-none"
                    />
                  </motion.div>
                )}
                  ...
                  >
                    ...
                    {!searchQuery && (
                      <motion.button
                        ...
                        className="mt-4 px-4 py-2 text-white rounded-xl font-bold"
                        style={{ background: accentColor }}
                      >
                        Connect to dApp
                      </motion.button>
              ...
              <div>
                <div className="mb-6">
                  ...
                  {/* QR Placeholder */}
                  <motion.div
                    className="mb-4 p-8 bg-white/5 rounded-xl border-2 border-dashed border-white/10 flex flex-col items-center justify-center cursor-pointer"
                    whileHover={{
                      scale: 1.02,
                  ...
                  >
                    ...
                    <p className="text-sm text-white/60 text-center mb-2">Tap to scan QR code</p>
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="flex gap-2">
                      <motion.input
                        ...
                        placeholder="wc:..."
                        className="flex-1 p-3 bg-white/5 border border-white/10 rounded-xl text-sm text-white placeholder-white/40 focus:border-white/30 outline-none transition-all"
                      />
                      <motion.button
                        whileHover={{ scale: 1.05 }}
                        whileTap={{ scale: 0.95 }}
                        onClick={handlePasteUri}
                        className="px-4 py-3 bg-white/5 border border-white/10 text-white rounded-xl hover:bg-white/10 transition-all text-sm flex items-center gap-2"
                      >
                  ...
                  <motion.button
                    ...
                    className="w-full mt-4 py-3 text-white rounded-xl font-bold transition-all disabled:opacity-50 disabled:cursor-not-allowed relative overflow-hidden"
                    style={{ background: accentColor }}
                  >
                    <AnimatePresence>
                      {loading && (
