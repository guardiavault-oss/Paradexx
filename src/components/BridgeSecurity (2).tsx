      ...
      >
        <div className="px-4 py-4">
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                <div className="flex items-center gap-2">
                  ...
                  <h2 className="text-white">Bridge Security</h2>
                </div>
                <p className="text-xs text-white/50 mt-0.5">Protected cross-chain transfers</p>
              </div>
            </div>
          ...
          <div className="grid grid-cols-4 gap-2 mb-4">
            ...
            >
              <div className="text-xs text-white/60">Bridges</div>
              <div className="text-lg text-white">{stats.totalBridges}</div>
            </motion.div>
            ...
            >
              ...
              <div className="text-lg text-white">{stats.avgSecurityScore}</div>
            </motion.div>
          </div>
        ...
        <AnimatePresence mode="wait">
          {activeTab === "bridges" && (
            ...
            >
              {/* Route Selection */}
              <div>
                <h3 className="text-sm text-white/60 mb-3">Select Route</h3>
                <div className="flex items-center gap-3">
                  <select
                    value={fromChain}
                  ...
                  {sortedBridges.map((bridge, index) => {
                    ...
                    return (
                      ...
                      >
                        <div className="flex items-start justify-between mb-3">
                          <div className="flex-1">
                            <div className="flex items-center gap-2 mb-2">
                              <h4 className="text-white">{bridge.name}</h4>
                              {isRecommended && (
                                <span
                            ...
                            <div className="flex items-center gap-2">
                              {bridge.isAudited && (
                                <span className="text-xs px-2 py-0.5 rounded bg-white/5 text-white/70 flex items-center gap-1">
                        ...
                        {bridge.recentIssues.length > 0 && (
                          <div className="pt-3 border-t" style={{ borderColor: "rgba(239, 68, 68, 0.2)" }}>
                            <div className="text-xs text-red-400 mb-1">Recent Issues:</div>
                            <ul className="text-xs text-red-400/70 space-y-1">
                              {bridge.recentIssues.map((issue, idx) => (
                                <li key={idx}>• {issue}</li>
                              ))}
                            </ul>
                          </div>
          ...
          {activeTab === "alerts" && (
            ...
            >
              <div>
                <h3 className="text-white mb-1">Security Alerts</h3>
                <p className="text-xs text-white/50">Real-time security monitoring</p>
              </div>
                ...
                {alerts.map((alert, index) => (
                  ...
                  >
                    <div className="flex items-start justify-between mb-2">
                      <div className="flex-1">
                        <div className="flex items-center gap-2 mb-2">
                          <h4 className="text-white text-sm">{alert.bridgeName}</h4>
                          <span
                        ...
                        <div className="text-xs text-white/60 mb-1">{alert.type}</div>
                        <p className="text-sm text-white/80">{alert.message}</p>
                      </div>
                    </div>
                    <div className="text-xs text-white/40">{formatTimeAgo(alert.timestamp)}</div>
                  </motion.div>
                ))}
              </div>
            </motion.div>
          ...
          {activeTab === "analytics" && (
            ...
            >
              <div>
                <h3 className="text-white mb-1">Security Analytics</h3>
                <p className="text-xs text-white/50">Bridge security trends and metrics</p>
              </div>
              ...
              >
                <h4 className="text-white text-sm mb-3">Security Score Distribution</h4>
                <div className="space-y-3">
                  {[
                    ...
                    <div key={idx}>
                      <div className="flex items-center justify-between mb-1">
                        ...
                        <span className="text-xs text-white">{item.count} bridges</span>
                      </div>
              ...
              <div className="grid grid-cols-2 gap-3">
                ...
                >
                  ...
                  <div className="text-xl text-white">$6.8B</div>
                  <div className="text-xs text-white/50 mt-1">All bridges</div>
                </div>
                ...
                >
                  <div className="flex items-center gap-2 mb-2">
                    ...
                    <div className="text-xs text-white/60">Validators</div>
                  </div>
                  <div className="text-xl text-white">
                    {bridges.reduce((sum, b) => sum + b.validators, 0)}
                  </div>
                  <div className="text-xs text-white/50 mt-1">Total across all</div>
                </div>
              </div>
            </motion.div>
          )}
              ...
              <div className="p-6">
                ...
                <div className="mb-6">
                  <div className="flex items-start justify-between mb-4">
                    <div>
                      <h3 className="text-xl text-white mb-1">{selectedBridge.name}</h3>
                ...
                <div className="space-y-4">
                  ...
                  >
                    <div className="grid grid-cols-2 gap-4">
                      <div>
                        ...
                        <div className="text-white mt-1">{selectedBridge.fees}%</div>
                      </div>
                      <div>
                        <div className="text-xs text-white/60">Avg Time</div>
                        <div className="text-white mt-1">{selectedBridge.avgTime}</div>
                      </div>
                      <div>
                        <div className="text-xs text-white/60">Total Volume</div>
                        <div className="text-white mt-1">{selectedBridge.totalVolume}</div>
                      </div>
                      <div>
                        <div className="text-xs text-white/60">Validators</div>
                        <div className="text-white mt-1">{selectedBridge.validators}</div>
                      </div>
                    </div>
                  </div>
                  ...
                  {selectedBridge.lastAudit && (
                    <div>
                      <div className="text-xs text-white/50 mb-1">Last Audit</div>
                      <div className="text-white">{selectedBridge.lastAudit}</div>
                    </div>
                  )}

                  <div>
                    <div className="text-xs text-white/50 mb-2">Supported Networks</div>
