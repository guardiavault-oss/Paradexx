  ...
  return (
    <AnimatePresence>
      <motion.div
        ...
        animate={{ opacity: 1 }}
        exit={{ opacity: 0 }}
        className="fixed inset-0 bg-black/90 backdrop-blur-xl z-[60] flex items-start justify-center overflow-y-auto py-8"
        onClick={onClose}
      >
        <motion.div
          ...
          className="w-full max-w-5xl mx-4 bg-black/95 backdrop-blur-2xl rounded-2xl border border-white/10 overflow-hidden shadow-2xl"
          style={{
            ...
            <div className="flex flex-col sm:flex-row gap-3 mb-4">
              <div className="flex-1 relative">
                ...
                <input
                  ...
                  className="w-full pl-12 pr-4 py-3 bg-white/5 backdrop-blur-xl rounded-xl text-white placeholder-white/30 focus:outline-none focus:bg-white/10 border border-white/10 focus:border-white/20 transition-all"
                />
              </div>
              <button
                onClick={() =>
                ...
                className={`px-4 py-3 rounded-xl flex items-center gap-2 transition-all font-black uppercase tracking-wider text-sm ${
                  showOnlyBeginner
...
function DappCard({
  ...
  return (
    <motion.div
      ...
      whileTap={{ scale: 0.98 }}
      className={`p-5 bg-white/5 backdrop-blur-xl rounded-xl border transition-all cursor-pointer ${
        isRisky
      ...
      <div className="flex items-start gap-4">
        ...
        <div className="flex-1 min-w-0">
          ...
          <div className="flex items-center gap-2 mb-2">
            <h4 className="font-black text-white truncate uppercase tracking-tight">
              {dapp.name}
            </h4>
            <button
              onClick={(e) => {
