...
export function MoreMenu({ type, onClose, onNavigate }: MoreMenuProps) {
      ...
      <div className="flex items-center gap-3">
        ...
        <div className="flex-1 min-w-0">
          <div className="flex items-center gap-2 mb-1">
            <span className="text-white font-[Bebas_Neue] text-[20px]">{item.title}</span>
            {item.isNew && (
              <span
          ...
          <p className="text-xs text-white/50 text-[rgba(255,255,255,0.3)]">{item.description}</p>
        </div>
  ...
  return (
    ...
    >
      {/* Header */}
      <div className="sticky top-0 z-30 bg-black/80 backdrop-blur-lg border-b border-white/10 rounded-[92px]">
        <div className="flex items-center justify-between md:px-6 md:py-4 max-w-7xl mx-[26px] rounded-[42px] px-[52px] py-[16px] my-[0px]">
          <div className="">
            <h1 className="text-3xl md:text-4xl font-black text-white tracking-tight">
              All Features
            </h1>
            <p className="text-sm text-white/50 mt-1">
              Explore all {isDegen ? 'Degen' : 'Regen'} tools
            </p>
          </div>
          <motion.button
      ...
      <div className="md:px-6 py-[32px] max-w-7xl mx-[0px] bg-[rgb(0,0,0)] rounded-[51px] my-[31px] px-[14px]">
        {/* Search Bar */}
        <div className="mb-6 md:mb-8">
          ...
          >
            ...
            <input
              ...
              className="flex-1 bg-transparent border-none outline-none text-[rgb(255,255,255)] placeholder-white/50 text-sm md:text-base px-[5px] py-[0px] mx-[-1px] my-[0px]"
            />
          </div>
        </div>
        ...
        <div className="space-y-6">
          {/* Search Results */}
          {filteredFeatures ? (
            <div className="px-[-99px] py-[0px]">
              <h3 className="text-sm text-white/60 mb-[-35px] uppercase tracking-wide text-[12px] text-[rgb(255,255,255)] px-[17px] py-[-64px] mt-[3px] mr-[0px] ml-[-9px]">
              ...
              {filteredFeatures.length === 0 ? (
                ...
                <div className="space-y-2 bg-[rgb(0,0,0)] px-[-38px] py-[50px] mx-[-6px] my-[-50px] rounded-[4px]">
