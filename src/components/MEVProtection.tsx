        ...
        <div className="px-4 py-4">
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                <div className="flex items-center gap-2">
                  ...
                  <h2 className="text-[var(--text-primary)]">MEV Protection</h2>
                </div>
          ...
          >
            <div className="flex items-center justify-between mb-3">
              <div>
                <div className="text-xs text-[var(--text-primary)]/60 mb-1">Protection Status</div>
                <div className="flex items-center gap-2">
                  {protectionEnabled ? (
                    <>
                      <Lock className="w-4 h-4" style={{ color: colors.secondary }} />
                      <span className="text-sm text-[var(--text-primary)]">Fully Protected</span>
                    </>
                  ) : (
                    <>
                      <Unlock className="w-4 h-4 text-red-500" />
                      <span className="text-sm text-[var(--text-primary)]">Unprotected</span>
                    </>
                  )}
                </div>
              </div>
            ...
            <div className="grid grid-cols-3 gap-3">
              <div>
                <div className="text-xs text-[var(--text-primary)]/50">Level</div>
                <div className="text-sm text-[var(--text-primary)] capitalize mt-1">{protectionLevel}</div>
              </div>
              <div>
                <div className="text-xs text-[var(--text-primary)]/50">Networks</div>
                <div className="text-sm text-[var(--text-primary)] mt-1">
                  {networks.filter((n) => n.active).length}
                </div>
              </div>
              <div>
                <div className="text-xs text-[var(--text-primary)]/50">Response Time</div>
                <div className="text-sm text-[var(--text-primary)] mt-1">{stats.avgResponseTime}ms</div>
              </div>
            </div>
          </motion.div>
          ...
          <div className="grid grid-cols-3 gap-2 mb-4">
            ...
            >
              <div className="flex items-center gap-2 mb-1">
                ...
                <div className="text-xs text-[var(--text-primary)]/60">Blocked</div>
              </div>
              <div className="text-lg text-[var(--text-primary)]">{stats.threatsBlocked}</div>
            ...
            >
              <div className="flex items-center gap-2 mb-1">
                ...
                <div className="text-xs text-[var(--text-primary)]/60">Protected</div>
              </div>
              <div className="text-lg text-[var(--text-primary)]">${(stats.valueProtected / 1000).toFixed(1)}K</div>
              <div className="text-xs" style={{ color: colors.secondary }}>
                saved
              </div>
            </motion.div>
            ...
            >
              <div className="flex items-center gap-2 mb-1">
                ...
                <div className="text-xs text-[var(--text-primary)]/60">MEV Saved</div>
              </div>
              <div className="text-lg text-[var(--text-primary)]">{stats.mevSaved} ETH</div>
              <div className="text-xs" style={{ color: colors.secondary }}>
                recovered
              </div>
            </motion.div>
        ...
        <AnimatePresence mode="wait">
          {activeTab === "overview" && (
            ...
            >
              {/* Protected Address */}
              <div>
                <h3 className="text-sm text-[var(--text-primary)]/60 mb-3">Protected Address</h3>
                <motion.div
                ...
                >
                  <div className="flex items-center justify-between">
                    <div className="flex-1 min-w-0">
                      <div className="text-xs text-[var(--text-primary)]/50 mb-1">Wallet Address</div>
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <motion.button
                        ...
                        style={{ background: "rgba(255, 255, 255, 0.05)" }}
                      >
                        <ExternalLink className="w-4 h-4 text-[var(--text-neutral)]" />
                      </motion.button>
                    </div>
                  </div>

                  <div className="grid grid-cols-2 gap-3 mt-4 pt-4 border-[var(--border-neutral)]">
                    <div>
                      <div className="text-xs text-[var(--text-primary)]/50">Auto-Protect</div>
                      <div className="flex items-center gap-2 mt-1">
                        {autoProtect ? (
                          ...
                          <>
                            ...
                            <span className="text-sm text-[var(--text-primary)]">Disabled</span>
                          </>
                        )}
                      </div>
                    </div>
                    <div>
                      <div className="text-xs text-[var(--text-primary)]/50">Private Mempool</div>
                      <div className="flex items-center gap-2 mt-1">
                        {privateMempool ? (
                          <>
                            <Lock className="w-4 h-4" style={{ color: colors.secondary }} />
              ...
              <div>
                <div className="flex items-center justify-between mb-3">
                  <h3 className="text-sm text-[var(--text-primary)]/60">Recent Threats Blocked</h3>
                  <motion.button
                    whileTap={{ scale: 0.95 }}
                    ...
                    return (
                      ...
                      >
                        <div className="flex items-center gap-3">
                          ...
                          <div className="flex-1 min-w-0">
                            <div className="flex items-center gap-2 mb-1">
                              <span className="text-sm text-[var(--text-primary)]">{getThreatLabel(threat.type)}</span>
                              <span
                            ...
                            <div className="flex items-center gap-2 text-xs text-[var(--text-primary)]/50">
                          ...
                          <div className="text-right shrink-0">
                            ...
                            <div className="text-xs text-[var(--text-primary)]/50">saved</div>
                          </div>
                        </div>
                      </motion.div>
                    );
              ...
              {/* Performance Metrics */}
              <div>
                <h3 className="text-sm text-[var(--text-primary)]/60 mb-3">Performance Metrics</h3>
                <div className="grid grid-cols-2 gap-3">
                  ...
                  >
                    <div className="flex items-center gap-2 mb-2">
                      <CheckCircle2 className="w-4 h-4" style={{ color: colors.secondary }} />
                      <div className="text-xs text-[var(--text-primary)]/60">Success Rate</div>
                    </div>
                    <div className="text-2xl text-[var(--text-primary)] mb-1">{stats.successRate}%</div>
                    <div className="text-xs text-[var(--text-primary)]/50">All transactions</div>
                  </motion.div>
                  ...
                  >
                    <div className="flex items-center gap-2 mb-2">
                      ...
                      <div className="text-xs text-[var(--text-primary)]/60">Avg Response</div>
                    </div>
                    <div className="text-2xl text-[var(--text-primary)] mb-1">{stats.avgResponseTime}ms</div>
                    <div className="text-xs text-[var(--text-primary)]/50">Detection time</div>
                  </motion.div>
                </div>
              </div>
            </motion.div>
          ...
          {activeTab === "threats" && (
            ...
            >
              <div>
                <h3 className="text-[var(--text-primary)] mb-1">Threat Detection Log</h3>
                <p className="text-xs text-[var(--text-primary)]/50">All detected and blocked threats</p>
              </div>
                  ...
                  return (
                    ...
                    >
                      <div className="flex items-start gap-3 mb-3">
                        ...
                        <div className="flex-1 min-w-0">
                          <div className="flex items-center gap-2 mb-2">
                            <h4 className="text-[var(--text-primary)]">{getThreatLabel(threat.type)}</h4>
                            <span
                              className="text-xs px-2 py-0.5 rounded capitalize"
                              style={{
                                background: `${getThreatColor(threat.severity)}20`,
                          ...
                          <div className="grid grid-cols-2 gap-3 mb-3">
                            <div>
                              <div className="text-xs text-[var(--text-primary)]/50">Network</div>
                              <div className="text-sm text-[var(--text-primary)]">{threat.network}</div>
                            </div>
                            <div>
                              <div className="text-xs text-[var(--text-primary)]/50">Confidence</div>
                              <div className="text-sm text-[var(--text-primary)]">
                                {(threat.confidence * 100).toFixed(0)}%
                              </div>
                            </div>
                            <div>
                              <div className="text-xs text-[var(--text-primary)]/50">Estimated Loss</div>
                              <div className="text-sm" style={{ color: colors.secondary }}>
                                ${threat.estimatedLoss}
                              </div>
                            </div>
                            <div>
                              <div className="text-xs text-[var(--text-primary)]/50">Time</div>
                              <div className="text-sm text-[var(--text-primary)]">
                          ...
                          {threat.transactionHash && (
                            <div className="flex items-center gap-2">
                              ...
                              <motion.button
                                ...
                                style={{ background: "rgba(255, 255, 255, 0.05)" }}
                              >
                                <ExternalLink className="w-3 h-3 text-[var(--text-primary)]/50" />
                              </motion.button>
                            </div>
                          )}
                        </div>
          ...
          {activeTab === "networks" && (
            ...
            >
              <div>
                <h3 className="text-[var(--text-primary)] mb-1">Network Monitoring</h3>
                ...
                {networks.map((network, index) => (
                  ...
                  >
                    <div className="flex items-start justify-between mb-3">
                      <div>
                        <div className="flex items-center gap-2 mb-1">
                          <h4 className="text-[var(--text-primary)]">{network.name}</h4>
                          {network.active ? (
                            <span
                              className="text-xs px-2 py-0.5 rounded flex items-center gap-1"
                              style={{
                            ...
                            <span className="text-xs px-2 py-0.5 rounded bg-white/5 text-[var(--text-primary)]/40">
                              Inactive
                            </span>
                          )}
                        </div>
                        <div className="text-xs text-[var(--text-primary)]/50">Chain ID: {network.chainId}</div>
                      </div>
                      <motion.button
                        whileTap={{ scale: 0.95 }}
                    ...
                    {network.active && (
                      <div className="grid grid-cols-3 gap-3">
                        <div>
                          <div className="text-xs text-[var(--text-primary)]/50">Latency</div>
                          <div className="text-sm text-[var(--text-primary)]">{network.latency}ms</div>
                        </div>
                        <div>
                          <div className="text-xs text-[var(--text-primary)]/50">Transactions</div>
                          <div className="text-sm text-[var(--text-primary)]">
                            {network.txCount.toLocaleString()}
                          </div>
                        </div>
                        <div>
                          <div className="text-xs text-[var(--text-primary)]/50">Threats</div>
                          <div className="text-sm" style={{ color: colors.secondary }}>
          ...
          {activeTab === "settings" && (
            ...
            >
              <div>
                <h3 className="text-[var(--text-primary)] mb-1">Protection Settings</h3>
                <p className="text-xs text-[var(--text-primary)]/50">Configure MEV protection parameters</p>
              </div>
              ...
              >
                <div className="mb-4">
                  <div className="text-[var(--text-primary)] text-sm mb-1">Protection Level</div>
                    ...
                    >
                      <div className="flex items-center justify-between">
                        <div>
                          ...
                          <div className="text-xs text-[var(--text-primary)]/50 mt-1">{level.desc}</div>
                        </div>
              ...
              >
                <div className="flex items-center justify-between">
                  <div>
                    <div className="text-[var(--text-primary)] text-sm mb-1">Auto-Protect</div>
                    <div className="text-xs text-[var(--text-primary)]/50">
              ...
              >
                <div className="flex items-center justify-between">
                  <div>
                    <div className="text-[var(--text-primary)] text-sm mb-1">Private Mempool</div>
                    <div className="text-xs text-[var(--text-primary)]/50">
              ...
              >
                <div className="mb-3">
                  <div className="text-[var(--text-primary)] text-sm mb-1">Threat Notifications</div>
                  <div className="text-xs text-[var(--text-primary)]/50">Get alerts for detected threats</div>
                </div>
                <div className="flex items-center gap-2">
                  <motion.button
                    whileTap={{ scale: 0.95 }}
                  ...
                  <motion.button
                    whileTap={{ scale: 0.95 }}
                    className="flex-1 py-2 rounded-lg text-sm text-[var(--text-primary)]/60"
                    style={{
                      background: "rgba(255, 255, 255, 0.05)",
                      border: `1px solid ${colors.border}`,
                    }}
