...
export default function SettingsModal({ type, isOpen, onClose, onLogout, onNavigate, onTribeSwitch }: SettingsModalProps) {
  ...
  return (
    <motion.div
      ...
      animate={{ opacity: 1 }}
      exit={{ opacity: 0 }}
      className="fixed inset-0 bg-black z-50 overflow-y-auto pb-20"
    >
      {/* Header */}
      <div
          ...
          <div className="flex gap-2 mt-6 overflow-x-auto scrollbar-hide pb-2">
            {[
              ...
              <motion.button
                ...
                style={{
                  background: activeTab === tab.id ? colors.gradient : "rgba(255, 255, 255, 0.03)",
        ...
        <AnimatePresence mode="wait">
          ...
          {activeTab === "general" && (
            ...
            >
              ...
              >
                <h3 className="text-white font-semibold mb-4 text-lg">Tribe Selection</h3>
                <div className="grid grid-cols-1 gap-3">
                  <button
                    onClick={() => handleSwitchMode("degen")}
                    className="w-full p-4 rounded-xl flex items-center justify-between transition-all"
                    style={{
                      background: isDegen ? "linear-gradient(135deg, rgba(220, 20, 60, 0.2), rgba(0,0,0,0))" : "rgba(255, 255, 255, 0.03)",
                      border: `1px solid ${isDegen ? "#DC143C" : "rgba(255,255,255,0.1)"}`,
                    }}
                  >
                    <div className="flex items-center gap-4">
                      ...
                      <div className="text-left">
                        <div className="text-white font-bold">Degen Tribe</div>
                        <div className="text-xs text-white/50">High risk, leverage, apeing</div>
                      </div>
                    </div>
                  ...
                  >
                    <div className="flex items-center gap-4">
                      ...
                      <div className="text-left">
                        <div className="text-white font-bold">Regen Tribe</div>
                        <div className="text-xs text-white/50">Safety, yield, governance</div>
                      </div>
                    </div>
              ...
              >
                ...
                <div className="space-y-2">
                  <div className="flex items-center justify-between p-3 rounded-xl bg-white/5">
                    ...
                    <span className="text-xs text-white/50 bg-white/10 px-2 py-1 rounded">Dark Mode</span>
                  </div>
                  <div className="flex items-center justify-between p-3 rounded-xl bg-white/5">
                    <div className="flex items-center gap-3">
                    ...
                    <span className="text-xs text-white/50 bg-white/10 px-2 py-1 rounded">English</span>
                  </div>
                </div>
              </div>
            </motion.div>
            ...
            >
              ...
              >
                <div className="flex items-center justify-between mb-4">
                   <h3 className="text-white font-semibold">Password & Authentication</h3>
                ...
                <div className="space-y-4">
                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <div className="text-xs text-white/50">Google Auth, Authy</div>
                      </div>
                    </div>
                    <button 
                      onClick={() => {
                  ...
                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        <div className="text-white text-sm">Biometrics</div>
                        <div className="text-xs text-white/50">FaceID / TouchID</div>
                      </div>
                    </div>
              ...
              >
                <div className="flex items-center justify-between mb-4">
                  <h3 className="text-white font-semibold">Auto-Lock Timer</h3>
                ...
                <select 
                  ...
                  className="w-full bg-black/50 border border-white/10 rounded-xl p-3 text-white focus:outline-none"
                >
              ...
              >
                <div className="flex items-start gap-3 mb-4">
                  ...
                  <div>
                    <h3 className="text-white mb-1">Recovery Phrase</h3>
                ...
                <button
                  ...
                  className="w-full p-3 rounded-xl flex items-center justify-between mb-3 bg-black/40 border border-white/10"
                >
                ...
                {showSeedPhrase && (
                  ...
                  >
                    <div className="p-4 rounded-xl mb-3 bg-black/60 border border-white/10 font-mono text-sm text-white/80">
                      {seedPhrase}
                    </div>
                    <button
                      onClick={handleCopySeed}
                      className="w-full p-3 rounded-xl flex items-center justify-center gap-2 font-bold text-white transition-all hover:opacity-90"
                      style={{ background: colors.primary }}
                    >
            ...
            >
              ...
              >
                <div className="relative mb-4 group cursor-pointer" onClick={handleProfileUpload}>
                  <div className="w-24 h-24 rounded-full bg-gradient-to-tr from-gray-800 to-gray-600 flex items-center justify-center overflow-hidden border-2 border-white/10">
                ...
                <p className="text-sm text-white/50 mb-4">{currentMode === 'degen' ? 'Degen Elite' : 'Regen Guardian'}</p>
              ...
              >
                <h3 className="text-white font-semibold mb-4">Privacy Level</h3>
                <div className="space-y-3">
                  {['public', 'friends', 'private'].map((level) => (
                    ...
                    >
                      <div className="capitalize text-white">{level}</div>
                      {privacyLevel === level && <Check className="w-4 h-4" style={{color: colors.primary}} />}
                    </button>
                  ))}
                </div>
              </div>
              ...
              {/* Data Actions */}
              <div className="space-y-3">
                <button className="w-full p-4 rounded-xl border border-white/10 bg-white/5 flex items-center justify-between text-white hover:bg-white/10 transition-colors">
                  <div className="flex items-center gap-3">
                  ...
                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <div className="text-xs text-white/50">Alerts on your device</div>
                      </div>
                    </div>
                    <button 
                      onClick={() => {
                  ...
                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <div className="text-xs text-white/50">Weekly digests & security</div>
                      </div>
                    </div>
                    <button 
                      onClick={() => {
                ...
                <div className="space-y-4">
                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-3">
                      ...
                      <div className="text-white text-sm">Price Volatility</div>
                    </div>
                    <button 
                  ...
                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-3">
                      ...
                      <div className="text-white text-sm">Transaction Success</div>
                    </div>
          ...
          {activeTab === "features" && (
            <motion.div
              ...
              className="space-y-4"
            >
              <h3 className="text-white font-semibold pl-1">
                ...
                {(currentMode === 'degen' ? degenFeatures : regenFeatures).map((feature) => (
                  ...
                  >
                    <div className="flex items-center gap-4">
                      ...
                      >
                        <feature.icon className="w-5 h-5" style={{ color: colors.primary }} />
                      </div>
                      <div className="text-left">
                        <div className="text-sm font-bold text-white group-hover:text-[${colors.primary}] transition-colors">
                          {feature.label}
                        </div>
