      ...
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 py-3 sm:py-4 flex items-center justify-between">
          ...
          <div className="flex items-center gap-2 sm:gap-4">
            ...
            <div>
              <h1
                className="text-base sm:text-2xl font-black text-white uppercase"
                style={{
          ...
          <div className="space-y-4 sm:space-y-6">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
              <motion.button
                ...
                className="p-4 rounded-xl border text-left hover:border-white/30 transition-all"
                style={{
                  background: "rgba(0, 0, 0, 0.4)",
                  backdropFilter: "blur(20px)",
                  borderColor: "rgba(255, 255, 255, 0.1)",
              ...
              >
                ...
                <div className="text-sm text-white">GuardianX</div>
              </motion.button>
            ...
            {isDegen ? (
              <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-4">
                ...
                <motion.div
                  ...
                  className="p-6 rounded-xl border cursor-pointer hover:border-white/30 transition-all"
                  style={{
                    background: "rgba(0, 0, 0, 0.4)",
                    backdropFilter: "blur(20px)",
                    borderColor: "rgba(255, 255, 255, 0.1)",
                ...
                >
                  <div className="flex items-center justify-between mb-4">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        <div className="text-white font-bold">Sniper Bot</div>
                        <div className="text-xs text-white/60">Auto-trade new launches</div>
                      </div>
                    </div>
                    <ChevronRight className="w-5 h-5 text-white/40" />
                  </div>
                  <div className="text-2xl text-white font-bold mb-1">5 Active</div>
                  ...
                  <div className="flex items-center justify-between mb-4">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <div className="text-xs text-white/60">Anti-frontrun</div>
                      </div>
                    </div>
                    <ChevronRight className="w-5 h-5 text-white/40" />
                  </div>
                  <div className="text-2xl text-white font-bold mb-1">Active</div>
                ...
                >
                  <div className="flex items-center justify-between mb-4">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        <div className="text-white font-bold">Whale Tracker</div>
                        <div className="text-xs text-white/60">Monitor whales</div>
                      </div>
                    </div>
                    <ChevronRight className="w-5 h-5 text-white/40" />
                  </div>
                  <div className="text-2xl text-white font-bold mb-1">8 Active</div>
                ...
                >
                  <div className="flex items-center justify-between mb-4">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        <div className="text-white font-bold">Airdrop Hunter</div>
                        <div className="text-xs text-white/60">Find free tokens</div>
                      </div>
                    </div>
                    <ChevronRight className="w-5 h-5 text-white/40" />
                  </div>
                  <div className="text-2xl text-white font-bold mb-1">5 Eligible</div>
                ...
                >
                  <div className="flex items-center justify-between mb-4">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        <div className="text-white font-bold">Wallet Guard</div>
                        <div className="text-xs text-white/60">24/7 Monitoring</div>
                      </div>
                    </div>
                    <ChevronRight className="w-5 h-5 text-white/40" />
                  </div>
                  <div className="text-2xl text-white font-bold mb-1 flex items-center gap-2">
                    <CheckCircle className="w-6 h-6 text-green-500" />
                    Secure
                  </div>
                  <div className="text-sm text-white/60">No threats detected</div>
                </motion.div>
                ...
                >
                  <div className="flex items-center justify-between mb-4">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        <div className="text-white font-bold">Inheritance</div>
                        <div className="text-xs text-white/60">Digital legacy</div>
                      </div>
                    </div>
                    <ChevronRight className="w-5 h-5 text-white/40" />
                  </div>
                  <div className="text-2xl text-white font-bold mb-1">3 Heirs</div>
                  <div className="text-sm text-white/60">Next check-in: 45 days</div>
                </motion.div>
                ...
                >
                  <div className="flex items-center justify-between mb-4">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        <div className="text-white font-bold">MEV Protection</div>
                        <div className="text-xs text-white/60">Safe trading</div>
                      </div>
                    </div>
                    <ChevronRight className="w-5 h-5 text-white/40" />
                  </div>
