...
export function SwapPage({ type, onClose, activeTab, onTabChange }: SwapPageProps) {
        ...
        <div className="px-4 py-4">
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                <div className="flex items-center gap-2">
                  ...
                  <h2 className="text-white">Trading</h2>
                </div>
          ...
          <div className="grid grid-cols-4 gap-2 mb-4">
            ...
            >
              ...
              <div className="text-lg text-white">{stats.activeOrders}</div>
            </div>
            ...
            >
              <div className="text-xs text-white/60">Executed</div>
            ...
            >
              <div className="text-xs text-white/60">DCA Plans</div>
            ...
            >
              ...
              <div className="text-lg text-white">{stats.totalVolume}</div>
            </div>
          </div>
            ...
            >
              ...
              >
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div className="flex-1">
                    <div className="text-white">{fromToken.symbol}</div>
                    <div className="text-xs text-white/50">{fromToken.name}</div>
                  </div>
                  <input
                    type="number"
                    value={fromAmount}
                    ...
                    placeholder="0.0"
                    className="w-32 bg-transparent text-right text-xl text-white outline-none"
                  />
                </div>
              ...
              >
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div className="flex-1">
                    <div className="text-white">{toToken.symbol}</div>
                    <div className="text-xs text-white/50">{toToken.name}</div>
                  </div>
                  <div className="text-xl text-white">{toAmount || "0.0"}</div>
                </div>
                <div className="text-right text-xs text-white/50 mt-2">
            ...
            >
              ...
              {orders.length === 0 ? (
                ...
                >
                  ...
                  <div className="text-white mb-1">No Limit Orders</div>
                  <p className="text-sm text-white/50">Create your first limit order</p>
                </div>
              ) : (
                      ...
                      >
                        <div className="flex items-center justify-between mb-3">
                          ...
                          <div className="text-right">
                            <div className="text-sm text-white">@ ${order.triggerPrice}</div>
                            <span
                        ...
                        <div className="flex items-center justify-between text-xs">
                          <span className="text-white/40">{formatTimeAgo(order.createdAt)}</span>
                          {order.status === "active" && (
                            <motion.button
                              whileTap={{ scale: 0.95 }}
          ...
          {activeTab === "dca" && (
            ...
            >
              ...
              {dcaPlans.length === 0 ? (
                ...
                >
                  <Repeat className="w-12 h-12 mx-auto mb-3 text-white/20" />
                  <div className="text-white mb-1">No DCA Plans</div>
                  <p className="text-sm text-white/50">Set up recurring purchases</p>
                </div>
              ) : (
                <div className="space-y-3">
      ...
      <AnimatePresence>
        {showOrderModal && (
          <>
            ...
            >
              <div className="p-6">
                <h3 className="text-xl text-white mb-4">Create Limit Order</h3>
                ...
                <div className="grid grid-cols-2 gap-4 mb-4">
                  <div>
                    ...
                    <input
                      ...
                      className="w-full bg-white/5 border rounded-xl p-3 text-white outline-none"
                      style={{ borderColor: colors.border }}
                      placeholder="USDC"
                    />
                  </div>
                ...
                <div className="grid grid-cols-2 gap-4 mb-6">
                  ...
                  <div>
                    <label className="text-sm text-white/60 mb-2 block">Trigger Price</label>
                    <input
                      type="number"
      ...
      <AnimatePresence>
        {showDCAModal && (
          <>
            ...
            >
              <div className="p-6">
                <h3 className="text-xl text-white mb-4">Create DCA Plan</h3>

                {/* Token */}
                <div className="mb-4">
                  <label className="text-sm text-white/60 mb-2 block">Token to Buy</label>
                  <div className="flex gap-2">
                ...
                {/* Amount */}
                <div className="mb-4">
                  <label className="text-sm text-white/60 mb-2 block">Amount per Purchase (USD)</label>
                  <div className="flex gap-2">
                ...
                {/* Total Budget */}
                <div className="mb-6">
                  <label className="text-sm text-white/60 mb-2 block">Total Budget (optional)</label>
                  <input
                    type="number"
