...
const TradingPage: React.FC<TradingPageProps> = ({ type = 'degen' }) => {
  ...
  return (
    <main className="min-h-screen bg-black px-4 pb-24 md:px-6 md:pb-20 lg:px-8" data-mode={type}>
        ...
        >
          <div className="flex items-center justify-between mb-4 md:mb-6">
            <div className="flex items-center gap-2 md:gap-3">
              ...
              <div>
                <h1 className="text-xl md:text-3xl lg:text-4xl font-black text-white tracking-tight">
                  Advanced Trading
                </h1>
                <p className="text-xs md:text-sm text-white/50 mt-0.5 md:mt-1">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-3 md:gap-4">
            ...
            >
              <p className="text-xs text-white/40 mb-1 uppercase tracking-wider truncate">Active Orders</p>
            ...
            >
              <p className="text-xs text-white/40 mb-1 uppercase tracking-wider truncate">Executed</p>
            ...
            >
              <p className="text-xs text-white/40 mb-1 uppercase tracking-wider truncate">Success Rate</p>
            ...
            >
              <p className="text-xs text-white/40 mb-1 uppercase tracking-wider truncate">Total Volume</p>
              ...
              <div className="space-y-3">
                {dcaPlans.length === 0 ? (
                  ...
                  >
                    ...
                    >
                      <Repeat className="w-10 h-10 text-white/30" />
                    </div>
                    <h3 className="text-xl font-black text-white mb-2">
                      No DCA Plans Yet
                    </h3>
      ...
      >
        ...
        >
          <div className="flex items-center justify-between mb-6">
            <h3 className="text-2xl font-black text-white">Create Limit Order</h3>
            <motion.button
          ...
          {/* Order Type */}
          <div className="mb-6">
            <label className="text-sm font-bold text-white/70 mb-3 block uppercase tracking-wider">
              Order Type
            </label>
          ...
          <div className="grid grid-cols-2 gap-4 mb-6">
            <div>
              <label className="text-sm font-bold text-white/70 mb-2 block">From</label>
              <input
                type="text"
            ...
            <div>
              <label className="text-sm font-bold text-white/70 mb-2 block">To</label>
              <input
                type="text"
          ...
          <div className="grid grid-cols-2 gap-4 mb-6">
            <div>
              <label className="text-sm font-bold text-white/70 mb-2 block">Amount</label>
              <input
                type="text"
            ...
            <div>
              <label className="text-sm font-bold text-white/70 mb-2 block">Trigger Price</label>
              <input
                type="text"
          ...
          {/* Slippage */}
          <div className="mb-6">
            <label className="text-sm font-bold text-white/70 mb-3 block">Slippage Tolerance</label>
  ...
  return (
    <AnimatePresence>
      ...
      >
        ...
        >
          <div className="flex items-center justify-between mb-6">
            <h3 className="text-2xl font-black text-white">Create DCA Plan</h3>
            <motion.button
              whileHover={{ scale: 1.1, rotate: 90 }}
              whileTap={{ scale: 0.9 }}
              onClick={onClose}
          ...
          {/* Amount */}
          <div className="mb-6">
            <label className="text-sm font-bold text-white/70 mb-3 block">Amount per Purchase (USD)</label>
          ...
          {/* Frequency */}
          <div className="mb-6">
            <label className="text-sm font-bold text-white/70 mb-3 block">Frequency</label>
            <div className="grid grid-cols-2 gap-2">
          ...
          {/* Total Budget */}
          <div className="mb-6">
            <label className="text-sm font-bold text-white/70 mb-2 block">Total Budget (Optional)</label>
            <input
              type="text"
