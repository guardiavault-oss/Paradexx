      ...
      >
        ...
        <div className="px-6 py-4 border-b flex items-center justify-between" style={{ borderColor: `${primaryColor}20` }}>
          <div className="flex items-center gap-3">
            ...
            <div>
              <h2 className="text-lg font-bold text-white">Yield Opportunities</h2>
              <p className="text-xs text-white/60">Curated high-quality DeFi strategies</p>
            </div>
          </div>
          <motion.button
          ...
          <div className="flex gap-2">
            {(["all", "low_risk", "high_yield"] as const).map((f) => (
              <motion.button
                ...
                style={{
                  background: filter === f ? primaryColor : "rgba(255, 255, 255, 0.05)",
        ...
        <div className="flex-1 overflow-y-auto p-6">
              ...
              >
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <div className="flex items-center gap-2">
                        <h3 className="text-sm font-bold text-white">{op.protocol}</h3>
                ...
                <div className="grid grid-cols-3 gap-4 pt-3 border-t" style={{ borderColor: `${primaryColor}20` }}>
                  <div>
                    ...
                    <div className="text-lg font-bold text-green-400">{op.apy}</div>
                  </div>
                  <div>
                    <div className="text-xs text-white/60 mb-1">TVL</div>
                    <div className="text-sm font-semibold text-white">{op.tvl}</div>
                  </div>
                  <div className="flex items-center justify-end">
                    <motion.button
                      ...
                      className="px-4 py-2 rounded-lg text-xs font-semibold text-white transition-all duration-200 flex items-center gap-2"
                      style={{
          ...
          >
            <div className="flex items-start gap-3">
              ...
              <div>
                <h4 className="text-sm font-semibold text-white mb-1">Risk Disclosure</h4>
