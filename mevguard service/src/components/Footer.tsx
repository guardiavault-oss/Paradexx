      ...
      <div className="max-w-7xl mx-auto px-6 py-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          ...
          <div className="col-span-1">
            ...
            <p className="text-gray-500 text-sm mb-3">
              Comprehensive MEV protection for your blockchain transactions.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li>
                <a href="#networks" className="text-gray-400 hover:text-emerald-400 transition-colors">
                  Supported Networks
                </a>
              </li>
              <li>
                <a 
                  href="https://status.mevguard.io" 
                  target="_blank" 
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li>
                <a 
                  href="https://docs.mevguard.io/api" 
                  target="_blank" 
                  rel="noopener noreferrer"
                  className="text-gray-400 hover:text-emerald-400 transition-colors inline-flex items-center gap-1"
                >
              ...
              <li>
                <a href="#changelog" className="text-gray-400 hover:text-emerald-400 transition-colors">
                  Changelog
                </a>
              </li>
              <li>
                <a href="#support" className="text-gray-400 hover:text-emerald-400 transition-colors">
                  Support
                </a>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li>
                <a href="#compliance" className="text-gray-400 hover:text-emerald-400 transition-colors">
                  Compliance
                </a>
              </li>
            </ul>
        ...
        <div className="border-t border-[#2a2a2a] pt-6 flex flex-col md:flex-row justify-between items-center gap-4">
          <p className="text-gray-500 text-sm">
            © {currentYear} MEVGUARD. All rights reserved.
          </p>
          <div className="flex items-center gap-4">
            <a 
              href="https://twitter.com/mevguard" 
              target="_blank" 
              rel="noopener noreferrer"
            ...
            <a 
              href="https://github.com/mevguard" 
              target="_blank" 
              rel="noopener noreferrer"
              className="text-gray-400 hover:text-emerald-400 transition-colors"
              aria-label="GitHub"
            ...
            <a 
              href="https://discord.gg/mevguard" 
              target="_blank" 
              rel="noopener noreferrer"
              className="text-gray-400 hover:text-emerald-400 transition-colors"
              aria-label="Discord"
